      ...
      <main className={style.center} ref={printRef}>
        ...
        <div className={style.introPic}>
          <div className={style.topIntro}>
            <img
              src="/images/speed-delivery-service-silhouette-icon-parcel-box-package-express-deliver-glyph-pictogram-fast-post-company-quick-shipping-order-to-home-icon-express-t.jpg"
              alt=""
            />
          </div>
          <div
